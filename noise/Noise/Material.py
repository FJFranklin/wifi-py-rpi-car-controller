class Material(object):
    ...
    def source():
        if Material.__source is None:
            Material.__source = Material('Source (generic)', (0,1,0,0.5))
    ...
    def diffzone():
        if Material.__diffzone is None:
            Material.__diffzone = Material('Diffraction Zone', (0,0,1,0.1))
    ...
    def darkzone():
        if Material.__darkzone is None:
            Material.__darkzone = Material('Dark Zone', (0,0,0,0.5))
    ...
    def concrete():
        if Material.__concrete is None:
            Material.__concrete = Material('Concrete', (1,1,1,1))
    ...
    def wood():
        if Material.__wood is None:
            Material.__wood = Material('Wood', (0.596, 0.412, 0.376, 1))
    ...
    def foliage():
        if Material.__foliage is None:
            Material.__foliage = Material('Foliage', (0, 0.5, 0, 0.75))
    ...
    def brick():
        if Material.__brick is None:
            Material.__brick = Material('Brick', (0.7,0.1,0,1))
    ...
    def grass():
        if Material.__grass is None:
            Material.__grass = Material('Grass', (0,0.5,0,1))
    ...
    def glass():
        if Material.__glass is None:
            Material.__glass = Material('Glass', (0,0,1,0.25))
    ...
    def label(self):        # 1 = total absorption
        return self._label
