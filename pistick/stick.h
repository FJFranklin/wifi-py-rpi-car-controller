...
const char * help[] = {
  ...
  "02          Say hello",
  "03          Tell time",
  "04          Repeat (or stop repeating) time",
  "0D          Echo off",
  "0E          Echo on",
  "0F          Reset all",
  ...
  "E0          Ext.Int.0: Off",
  "E0,01       Ext.Int.0: Count for 1 s",
  "E0,08       Ext.Int.0: Count for 0.8 ms",
  "E0,0E       Ext.Int.0: Notify on interrupt",
  "E0,20       Ext.Int.0: Count for 20 ms",
  0
};
